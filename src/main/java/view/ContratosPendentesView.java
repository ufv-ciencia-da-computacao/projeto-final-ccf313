 ...
 * @author dener
 */
public class ContratosPendentesView extends javax.swing.JPanel {
    ...
    private void aceitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceitarActionPerformed
        this.professorController.negociarContrato(user.getUsername(), 
